...
): Promise<{ response: string; tokens: number; cost: number; type: 'openai' | 'local' | 'mock' }> {
...
function generateMockGPTResponse(parsed: any, profile: any, carry_in: boolean, emotion_flip: boolean): { response: string; tokens: number; cost: number; type: 'openai' | 'local' | 'mock' } {
